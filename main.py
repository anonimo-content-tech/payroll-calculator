...
def export_to_excel(imss_results, imss_headers, imss_totals, 
    ...
    try:
        ...
        results_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "resultado_calculos")
        ...
        # Apply formatting to each worksheet - fixed to avoid using get_row_data
